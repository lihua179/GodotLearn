...
#        "D:\godot\Godot.exe" --headless --path "D:\godot_data\mcp" --script "C:\Users\admin\PycharmProjects\Work2024\ai_quant\主线\ai\mcp\src\scripts\godot_operations.gd" get_uid "{\"file_path\": \"res://main.tscn\"}"
