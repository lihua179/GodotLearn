...
class GodotServer {
    ...
    async detectGodotPath() {
        ...
        if (osPlatform === 'darwin') {
            possiblePaths.push('/Applications/Godot.app/Contents/MacOS/Godot', '/Applications/Godot_4.app/Contents/MacOS/Godot', `${process.env.HOME}/Applications/Godot.app/Contents/MacOS/Godot`, `${process.env.HOME}/Applications/Godot_4.app/Contents/MacOS/Godot`);
        }
        else if (osPlatform === 'win32') {
            possiblePaths.push('D:\\godot\\Godot.exe', 'D:\\godot\\Godot.exe', 'D:\\godot\\Godot.exe', 'D:\\godot\\Godot.exe', `${process.env.USERPROFILE}\\Godot\\Godot.exe`);
        }
        ...
        if (this.strictPathValidation) {
            ...
            if (osPlatform === 'win32') {
                this.godotPath = normalize('D:\\godot\\Godot.exe');
            }
